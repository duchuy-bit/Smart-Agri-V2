...
class DataSetFields{
  ...
  static final String humidity1 = 'humidity1';
  static final String temperature1 = 'temperature1';
  static final String light1 = 'light1';
  static final String humidity2 = 'humidity2';
  static final String temperature2 = 'temperature2';
  static final String light2 = 'light2';
  static final String humidity3 = 'humidity3';
  static final String temperature3 = 'temperature3';
  static final String light3 = 'light3';

  static final String DA_A1_MIN= 'DA_A1_MIN';
  static final String DA_A1_MAX= 'DA_A1_MAX';
  static final String DA_A2_MIN= 'DA_A2_MIN';
  static final String DA_A2_MAX= 'DA_A2_MAX';
  static final String DA_A3_MIN= 'DA_A3_MIN';
  static final String DA_A3_MAX= 'DA_A3_MAX';

  static final String ND_A1_MIN= 'ND_A1_MIN';
  static final String ND_A1_MAX= 'ND_A1_MAX';
  static final String ND_A2_MIN= 'ND_A2_MIN';
  static final String ND_A2_MAX= 'ND_A2_MAX';
  static final String ND_A3_MIN= 'ND_A3_MIN';
  static final String ND_A3_MAX= 'ND_A3_MAX';

  static final String AS_A1_MIN= 'AS_A1_MIN';
  static final String AS_A1_MAX= 'AS_A1_MAX';
  static final String AS_A2_MIN= 'AS_A2_MIN';
  static final String AS_A2_MAX= 'AS_A2_MAX';
  static final String AS_A3_MIN= 'AS_A3_MIN';
  static final String AS_A3_MAX= 'AS_A3_MAX';

  static final String TIME_OFF= 'TIME_OFF';
  static final String TIME_ON= 'TIME_ON';

  static final String TIME_BN1= 'TIME_BN1';
  static final String TIME_BN2= 'TIME_BN2';
  static final String TIME_BN3= 'TIME_BN3';
  static final String TIME_PS1= 'TIME_PS1';
  static final String TIME_PS2= 'TIME_PS2';
  static final String TIME_PS3= 'TIME_PS3';
  static final String TIME_AS1= 'TIME_AS1';
  static final String TIME_AS2= 'TIME_AS2';
  static final String TIME_AS3= 'TIME_AS3';
